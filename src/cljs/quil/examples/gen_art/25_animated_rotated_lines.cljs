(ns quil.examples.gen-art.animated-rotated-lines
  (:use-macros [quiljs.macros :only [defsketch]])
  (:use [quil.core :only [background stroke-weight smooth no-fill stroke radians
                          cos sin line push-matrix pop-matrix rotate translate weight height
                          noise frame-rate set-state! state random width]]
