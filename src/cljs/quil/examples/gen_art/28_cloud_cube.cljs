(ns quil.examples.gen-art.cloud-cube
  (:use-macros [quiljs.macros :only [defsketch]])
  (:use [quil.core :only [push-matrix translate fill box pop-matrix background frame-count random
                          rotate-z rotate-y noise background no-stroke set-state! state]]
