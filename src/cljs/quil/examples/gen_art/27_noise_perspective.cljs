(ns quil.examples.gen-art.noise-perspective
  (:use-macros [quiljs.macros :only [defsketch]])
  (:use [quil.core :only [push-matrix translate pop-matrix fill sphere noise smooth background sphere-detail
                          no-stroke random set-state! state width height]]
