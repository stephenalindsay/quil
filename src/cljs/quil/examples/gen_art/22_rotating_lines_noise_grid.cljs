(ns quil.examples.gen-art.rotating-lines-noise-grid
  (:use-macros [quiljs.macros :only [defsketch]])
  (:use [quil.core :only [background stroke-weight smooth no-fill stroke radians random height pop-matrix width
                          cos sin line push-matrix translate rotate popmatrix noise]]
