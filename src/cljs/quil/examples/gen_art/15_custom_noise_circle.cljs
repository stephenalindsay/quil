(ns quil.examples.gen-art.noise-circle
  ...
  (:use [quil.core :only [background stroke-weight smooth radians cos sin stroke no-fill ellipse
                          line begin-shape end-shape curve-vertex pow fill]]
...
(defn setup []
  ...
  (let [radius     100
        ...
        noise-vals (range noise-val (.-POSITIVE_INFINITY js/Number) 0.1)
