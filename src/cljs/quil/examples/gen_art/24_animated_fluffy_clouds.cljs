(ns quil.examples.gen-art.animated-fluffy-clouds
  (:use-macros [quiljs.macros :only [defsketch]])
  (:use [quil.core :only [background stroke-weight smooth no-fill stroke radians
                          cos sin line push-matrix translate rotate no-stroke
                          fill ellipse pop-matrix width height noise state frame-rate
                          random set-state!]]
