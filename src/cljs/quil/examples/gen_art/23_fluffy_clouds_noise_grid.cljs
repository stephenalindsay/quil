(ns quil.examples.gen-art.fluffy-clouds-noise-grid
  (:use-macros [quiljs.macros :only [defsketch]])
  (:use [quil.core :only [background stroke-weight smooth no-fill stroke radians
                          cos sin line push-matrix pop-matrix translate rotate
                          no-stroke fill eliipse random height width ellipse noise]]
