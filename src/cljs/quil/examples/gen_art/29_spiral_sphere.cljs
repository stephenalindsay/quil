(ns quil.examples.gen-art.spiral-sphere
  (:use-macros [quiljs.macros :only [defsketch]])
  (:use [quil.core :only [background stroke translate rotate-y rotate-x frame-count
                          radians cos sin cos line height width]]
